...
class LunarSafe(gym.Env, EzPickle):
    ...
    def render(self, mode='human'):
        ...
        self.viewer.draw_polyline([(constraint11x, constraint11y), (constraint12x, constraint12y)], color=(255, 0, 0))
        ...
        self.viewer.draw_polyline([(constraint21x, constraint21y), (constraint22x, constraint22y)], color=(255, 0, 0))
